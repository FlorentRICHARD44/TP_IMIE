...
<t:maintemplate pagetitle="Liste des Usagers" tabtitle="Liste des Utilisateurs">
		<form method="post" action="userview">
			...
			<table>
		            ...
		            <tr><td><input type="text" name="name" value="${param.name }"/></td><td><input type="text" name="firstname" value="${param.firstname }"/></td><td><input type="submit" class="action" value="Filtrer" name="filter"/></tr>
